...
#else
        [Tooltip("An object with a button that will offer to install a shortcut on the desktop (possibly for a fee). When clicking on the button, you need to run the Prompt Show method through this script or through the YandexGame script.")]
#endif
