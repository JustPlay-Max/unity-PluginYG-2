namespace YG
{
    public static partial class YG2
    {
        ...
        private static void InitEnvirForEditor()
        {
            ...
            switch (infoYG.simulationInEditor.device)
            {
                case Device.Desktop:
            ...
            if (infoYG.simulationInEditor.language != "" &&
                infoYG.simulationInEditor.language != null)
                envir.language = infoYG.simulationInEditor.language;
