...
#else
            iPlatform.InitStorage();
#endif
#if !Authorization
            if (infoYG.Storage.saveCloud)
            {
#if UNITY_EDITOR
                Debug.LogError("При использовании облачных сохранений необходимо импортировать зависимость - модуль Authorization.");
#else
                Debug.LogError("When using cloud saves, you need to import a dependency - Authorization module.");
#endif
            }
#endif
        }
