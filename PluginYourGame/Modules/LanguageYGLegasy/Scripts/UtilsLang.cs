...
namespace YG.LanguageLegasy
{
    public class UtilsLang : MonoBehaviour
    {
        public static bool[] LangArr(InfoYG.LanguageYGLegasySettings inf)
        {
            bool[] b = new bool[27];
        ...
        public static Font[] GetFont(int i, InfoYG.LanguageYGLegasySettings inf)
        {
...
#if TMP_YG2
        public static TMP_FontAsset[] GetFontTMP(int i, InfoYG.LanguageYGLegasySettings inf)
        {
        ...
        public static int[] GetFontSize(int i, InfoYG.LanguageYGLegasySettings inf)
        {
