...
namespace YG
{
    public partial class InfoYG
    {
        ...
        {
#if RU_YG2
            [Tooltip("Показывать рекламу при загрузке игры? (Первая реклама при открытии игры)")]
#else
            [Tooltip("Should I show ads when loading the game? (The first advertisement when opening the game)")]
#endif
