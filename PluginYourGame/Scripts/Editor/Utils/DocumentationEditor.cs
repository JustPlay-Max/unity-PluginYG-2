...
namespace YG.EditorScr
{
    ...
    {
#if RU_YG2
        [MenuItem("YG2/Помощь/Документация")]
#else
        [MenuItem("YG2/Help/Documentation")]
#endif
...
#if RU_YG2
        [MenuItem("YG2/Помощь/Чат")]
#else
        [MenuItem("YG2/Help/Chat")]
#endif
...
#if RU_YG2
        [MenuItem("YG2/Помощь/Видео")]
#else
        [MenuItem("YG2/Help/Video")]
#endif
